...
function dashboardBasis(summary){
  return `<div class="dash-basis-panel">
    <details><summary>매출 집계 기준 보기</summary>
      <p>총매출(등록금액)은 조회 기간의 취소 제외 Paid 품목 금액 합계입니다. 승인된 증빙 금액이 있으면 우선 사용하고, 없으면 수량 × 저장 단가로 계산합니다. 세금 기준 확인 필요 금액을 포함하며, 입금액이나 확정 공급가액을 뜻하지 않습니다. 월별현황·세금계산서의 등록금액도 같은 기준입니다. 공급가액 분석은 거래처 마스터의 영세·과세를 기본값으로 사용합니다.</p>
